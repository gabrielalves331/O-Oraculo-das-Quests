 ...
 * @author gabri
 */
public class EdicaoMissao extends javax.swing.JFrame {

    /**
     * Creates new form EdicaoMissao
     */
    public EdicaoMissao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Chedou até a Edição de uma missão");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EdicaoMissao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EdicaoMissao().setVisible(true);
            }
        });
    }
